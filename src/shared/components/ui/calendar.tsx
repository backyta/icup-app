  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: 'text-black text-[0.9rem] w-auto border-none dark:bg-slate-300 rounded-md',
        ...
        day: cn(
          ...
          'h-6 w-6 md:h-9 w-9 p-0  font-normal aria-selected:opacity-100 text-[12px] md:text-[14px]'
        ),
