...
export const UrbanSectorsPuentePiedraAllowed = [
  ...
  UrbanSectorNames.Chillón,
  UrbanSectorNames['Shangri La'],
  UrbanSectorNames['Tambo Inga Oeste'],
  UrbanSectorNames['Tambo Inga Este'],
  UrbanSectorNames['Pampa Libre'],
  UrbanSectorNames.Gallinazos,
  UrbanSectorNames['Santa Rosa'],
  UrbanSectorNames.Cercado,
  UrbanSectorNames['Las Vegas'],
  UrbanSectorNames['La Grama'],
  UrbanSectorNames.Copacabana,
  UrbanSectorNames['El Dorado'],
  UrbanSectorNames['Leoncio Prado'],
