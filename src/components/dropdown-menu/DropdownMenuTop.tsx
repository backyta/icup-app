      ...
      <SheetContent side={'top'} className='h-full'>
        <SheetHeader>
          ...
          <div id='logo' className='pt-3 pb-2 text-center'>
            ...
            >
              <h1 className='text-[2rem] font-bold text-white'>ICUP-App</h1>
              <span>
                <img
        ...
        <SheetClose asChild>
          <nav
            id='menu'
            className='w-full px-10 flex flex-col items-center py-4 gap-y-[1.5rem]'
          >
            ...
            <a className='flex justify-center w-full sm:w-[20rem] m-auto'>
              ...
              <span className='text-lg text-red-500 font-bold leading-5'>
                Salir
              </span>
            </a>
          </nav>
