...
export const BarChartOfferings = (): JSX.Element => {
  return (
    <Card className='bg-slate-200 flex flex-col row-start-1 row-end-2 col-start-1 col-end-3 md:row-start-1 md:row-end-2 md:col-start-1 md:col-end-3 xl:col-start-1 xl:col-end-4 xl:row-start-1 xl:row-end-2 h-[16rem] lg:h-[18rem] xl:h-[25rem] 2xl:h-[26rem] mt-3 xl:mt-5 lg:mt-5 lg-mb-5 md:mt-5 2xl:mt-10 border-slate-400'>
