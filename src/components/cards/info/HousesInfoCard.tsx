...
export function HousesInfoCard(): JSX.Element {
  return (
    <Card className='bg-slate-200 w-auto row-start-4 row-end-5 col-start-1 col-end-2 lg:row-start-3 md:row-end-4 md:col-start-1 md:col-end-3 xl:col-start-4 xl:col-end-7 xl:row-start-2 xl:row-end-3 md:h-[38rem] xl:h-auto 2xl:h-[38rem] lg:mt-0 xl-lv1:-mt-[5.5rem] xl:-mt-[10.5rem] 2xl:-mt-16'>
