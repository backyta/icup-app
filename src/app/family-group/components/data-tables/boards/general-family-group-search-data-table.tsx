...
import { getFamilyGroups } from '@/app/family-group/services';
import { type FamilyGroupQueryParams } from '@/app/family-group/interfaces';
...
export function GeneralFamilyGroupSearchDataTable<TData, TValue>({
  ...
  const query = useQuery({
    ...
    queryFn: async () => getFamilyGroups(searchParams as FamilyGroupQueryParams),
