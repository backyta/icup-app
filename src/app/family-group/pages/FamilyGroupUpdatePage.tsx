...
import { familyGroupUpdateColumns } from '@/app/family-group/components';
  ...
  return (
    <div>
      ...
      <p className='dark:text-slate-300 text-left font-sans font-bold px-4 text-[12.5px] md:text-[15px] xl:text-base sm:px-[1.5rem] xl:px-[2rem]'>
        Elige tus opciones de búsqueda para actualizar registros de casas familiares.
      </p>

      <div className='px-4 md:-px-2 md:px-[2rem] xl:px-[3rem] py-4 w-full'>
        <DataTableSearchByTerm columns={familyGroupUpdateColumns} data={data} />
      </div>
    </div>
  );
};
