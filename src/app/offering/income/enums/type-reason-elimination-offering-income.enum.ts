export enum TypeReasonEliminationOfferingIncome {
...
export const TypeReasonEliminationOfferingIncomeNames: Record<TypeReasonEliminationOfferingIncome, string> = {
