...
import { OfferingIncomeInfoCard, OfferingIncomeUpdateCard } from '@/app/offering/income/components';

import { Button } from '@/shared/components/ui/button';

import { type OfferingColumns } from '@/app/offering/shared/interfaces';

export const offeringIncomeUpdateColumns: Array<ColumnDef<OfferingColumns, any>> = [
  {
    accessorKey: 'id',
    header: ({ column }) => {
      return (
