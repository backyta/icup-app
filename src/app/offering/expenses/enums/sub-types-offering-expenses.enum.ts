...
// TODO : hacer cartilla de parentesis para saber donde poner casa subtipo (piso a tal)
  ...
  // electrical_services : 'Servicios de electricidad',
  // painting_and_touch_ups_services : 'Servicios de pintura y retoques',
  // deep_cleaning_services : 'Servicios de limpieza profunda (piso, paredes, cortinas, etc)',
  // heating_and_ac_system_maintenance : 'Mantenimiento de sistemas de calefacción y AC',
  // sound_and_lighting_equipment_repair_and_maintenance : 'Mantenimiento de equipos de sonido e iluminación',
  // garden_and_exterior_maintenance : 'Mantenimiento de jardines y exteriores',
  // furniture_repair_and_maintenance : ' Mantenimiento de muebles ',
  ...
  // Decoration Expenses
  // purchase_flowers_and_plants : 'Adquisición de flores y plantas',
  // purchase_decorative_furniture : 'Adquisición de muebles decorativos (floreros, alfombras, cortinas, etc)',
  // purchase_decorative_items : 'Adquisición de elementos decorativos (cuadros, banners, globos, etc)',
  // altar_and_worship_area_decoration_service : 'Servicio de decoración de altar y areas de culto',

  // Equipment and Technology Expenses
  // sound_equipment : 'Equipos de sonido (altavoces, micrófonos, mezcladoras, etc)',
  // projection_equipment : 'Equipos de proyección (proyectores, pártanlas, etc)',
  // hvac_equipment : 'Equipos de ventilación, calefacción y AC',
  // lighting_equipment : 'Equipos de iluminación (luminarias, reflectores, etc)',
  // security_equipment : 'Equipos de seguridad (cámaras, cableado, etc )',
  // office_equipment : 'Equipos de oficina (escritorios, fotocopiadoras, etc)',
  // computer_equipment : 'Equipos informáticos (computadoras, impresoras, etc)',
  // audio_video_recording_equipment : 'Equipos de grabación de audio/video',
  // furniture : 'Mobiliario (mesas, pizarras, estanterías, etc)',
  // musical_instruments : 'Instrumentos musicales (órganos, guitarras, etc)',
  // internet_and_telecommunications_services : ' Servicios de internet y telecomunicaciones',
  // hosting_and_software_services   : 'Servicios de Hosting y Software',

  // Supplies Expenses
  // kitchen_utensils : 'Utensilios de cocina (ollas, sartenes, gas, etc)',
  // cooking_ingredients : 'Ingredientes de cocina (aceite, arroz, especias, etc)',
  // office_supplies : 'Utensilios de oficina (papel A4, sobres, bolígrafos, etc)',
  // cleaning_materials : 'Materiales de limpieza (detergente, mopas, jabón, etc)',
  // packaging_and_storage_materials : 'Materiales de almacenamiento (tupers, box de plástico, etc)',
  // sunday_school_educational_materials : ' Material educativo Esc. Dominical (libros, colores, mat. didáctico, etc)',

  // Activities and Events Expenses
  // fees_special_guests : 'Honorarios para invitados especiales (oradores, músicos, etc)',
  // fees_support_staff : 'Honorarios de personal de apoyo (seguridad, limpieza, etc)',
  // rental_external_venues : 'Alquiler de locales externos (salones, auditorios, etc)',
  // rental_technical_and_logistical_equipment : 'Alquiler de equipos técnicos y logísticos (carpas, sonido, iluminación, etc)',
  // transportation_special_guests : 'Transporte para invitados especiales',
  // equipment_transportation : 'Transporte de equipos',
  // food_beverage : 'Comida y bebida (catering, alimentos y refrescos)',
  // decorations_and_ambiance : 'Decoraciones y ambientación (flores, globos, pancartas, etc)',
  // promotional_materials : 'Material promocional (folletos, carteles, invitaciones, etc)',
  // educational_materials_and_resources : 'Material didáctico y recursos (material educativo, juegos, etc)',
  // gifts_and_prizes_participants : 'Regalos y premios para participantes',
  // other_related_expenses : ' Otros gastos relacionados (permisos, seguros, planificación)',