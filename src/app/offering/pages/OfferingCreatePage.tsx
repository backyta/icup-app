...
import { type FilesProps, type RejectedProps } from '@/app/offering/interfaces';
import { CurrencyTypeNames, SubTypesOffering, SubTypesOfferingNames } from '@/app/offering/enums';
  ...
  return (
    <>
      ...
      <p className='dark:text-slate-300 text-left font-sans text-[13px] font-bold px-4 sm:px-10 sm:text-sm md:text-base 2xl:px-24'>
        Por favor llena los siguientes datos para crear un nuevo registro de ofrenda.
      </p>
            ...
            <div className='lg:col-start-1 lg:col-end-2'>
                  ...
                  render={({ field }) => {
                    return (
                      <FormItem className='mt-4'>
                        <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Sub-Tipo</FormLabel>
                        <FormDescription className='text-sm lg:text-[15px]'>
              ...
              <FormField
                ...
                render={({ field }) => {
                  return (
                    <FormItem className='mt-4'>
                      <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Comentarios</FormLabel>
                      <FormControl>
                        <Textarea placeholder='Comentarios referente al registro de la ofrenda' {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  );
              ...
              {(type === 'tithe' ||
                ...
                (type === 'offering' && subType === SubTypesOffering.ChurchGround)) && (
                <FormField
                  control={form.control}
                  name='memberID'
                  render={({ field }) => (
                    <FormItem className='flex flex-col mt-4'>
                      ...
                      <Popover open={open} onOpenChange={setOpen}>
                        ...
                        <PopoverContent className='mr-30 w-[20rem] p-2\'>
                          <Command>
                            <CommandInput placeholder='Busque un miembro...' className='h-9 text-sm lg:text-[15px]' />
              ...
              {type === 'offering' && subType === SubTypesOffering.FamilyHouse && (
                <FormField
                  control={form.control}
                  name='familyHouseID'
                  render={({ field }) => (
                    <FormItem className='flex flex-col mt-4'>
                      <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Casa Familiar</FormLabel>
                      <FormDescription className='text-sm lg:text-[15px]'>
              ...
              {((type === 'offering' && subType === SubTypesOffering.ZonalFasting) ||
                (type === 'offering' && subType === SubTypesOffering.ZonalVigil)) && (
                <FormField
                  control={form.control}
                  name='copastorID'
                  render={({ field }) => (
                    <FormItem className='flex flex-col mt-4'>
                      ...
                      <Popover open={open} onOpenChange={setOpen}>
                        ...
                        <PopoverContent className='w-[20rem] p-2'>
                          <Command>
                            <CommandInput placeholder='Busque un co-pastor...' className='h-9 text-sm lg:text-[15px]' />
                ...
                render={() => {
                  return (
                    <FormItem className='mt-4 md:mt-0'>
                      <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Subir imagen</FormLabel>
                      <FormControl>
                        <div
                          {...getRootProps({
                            className:
