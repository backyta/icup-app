          ...
          >
            <div className='md:col-start-1 md:col-end-2'>
              ...
              {(type === TypesOffering.Tithe ||
                ...
                (type === TypesOffering.Offering && subType === SubTypesOffering.ChurchGround)) && (
                <FormField
                  control={form.control}
                  name='memberID'
                  render={({ field }) => (
              ...
              {((type === TypesOffering.Offering && subType === SubTypesOffering.ZonalFasting) ||
                (type === TypesOffering.Offering && subType === SubTypesOffering.ZonalVigil)) && (
                <FormField
                  control={form.control}
                  name='zoneID'
                  render={({ field }) => (
