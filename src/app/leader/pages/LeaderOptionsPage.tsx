      ...
      <div className='w-full px-[2rem] py-6 sm:px-[7rem] md:px-[4rem] lg:px-[3rem] xl:px-[3rem] 2xl:px-16 grid gap-8 md:gap-6 xl:gap-5 2xl:gap-4 grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1 2xl:grid-cols-4 2xl:grid-rows-1 h-auto 2xl:h-[43rem]'>
        ...
        >
          <WhiteCard className='md:h-[11rem]' centered>
            ...
            <p className='font-bold text-[14px] lg:text-[15px] xl:text-[16px]'>
              Crear nuevo registro de un líder.
            </p>
          </WhiteCard>
        </NavLink>

        <NavLink
          key='/leaders/search-leaders'
          to='/leaders/search-leaders'
          end
        ...
        >
          <WhiteCard className='md:h-[11rem]' centered>
            ...
            <p className='font-bold text-[14px] lg:text-[15px] xl:text-[16px]'>
              Consultar registros de lideres en general.
            </p>
          </WhiteCard>
        </NavLink>

        <NavLink
          key='/leaders/search-by-term-leaders'
          to='/leaders/search-by-term-leaders'
          end
        ...
        >
          <WhiteCard className='md:h-[11rem]' centered>
            ...
            <p className='font-bold text-[14px] lg:text-[15px] xl:text-[16px]'>
              Consultar registros de lideres por tipo.
            </p>
          </WhiteCard>
        </NavLink>

        <NavLink
          key='/leaders/update-leader'
          to='/leaders/update-leader'
          end
        ...
        <NavLink
          key='/leaders/delete-leader'
          to='/leaders/delete-leader'
          end
        ...
        >
          <WhiteCard className='md:h-[11rem]' centered>
            ...
            <p className='font-bold text-[14px] lg:text-[15px] xl:text-[16px]'>
              Eliminar el registro de un líder.
            </p>
          </WhiteCard>
        </NavLink>
      </div>
