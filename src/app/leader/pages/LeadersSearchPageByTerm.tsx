...
export const LeadersSearchPageByTerm = (): JSX.Element => {
  return (
    <div>
      ...
      <h2 className='text-left px-4 py-2 sm:px-2 sm:pt-4 sm:pb-2 lg:px-[1.5rem] xl:px-[2rem] 2xl:px-24 2xl:pt-4 font-sans text-2xl sm:text-2xl font-bold text-blue-500 text-[1.5rem] sm:text-[1.75rem] md:text-[1.85rem] lg:text-[1.9rem] xl:text-[2.1rem] 2xl:text-4xl'>
        Buscar lideres por termino
      </h2>
      <p className='dark:text-slate-300 text-left font-sans font-bold px-4 sm:px-2 text-[12.5px] lg:px-[1.5rem] md:text-[15px] xl:text-base xl:px-[2rem] 2xl:px-24'>
        Busca, filtra y ordena los lideres que necesites.
      </p>
