...
export const LeadersGeneralSearchPage = (): JSX.Element => {
  return (
    <div>
      ...
      <p className='dark:text-slate-300 text-left font-sans font-bold px-4 sm:px-2 text-[12.5px] md:text-[15px] xl:text-base lg:px-[1.5rem] xl:px-[2rem] 2xl:px-24'>
