...
import { CopastorInfoCard, CopastorUpdateCard } from '@/app/copastor/components';

import { Button } from '@/shared/components/ui/button';

export const copastorUpdateColumns: Array<ColumnDef<CopastorColumns, any>> = [
  {
    accessorKey: 'id',
    cell: (info) => {
...

  {
    ...
    cell: (info) => {
      const id = info.row.original.id;
      return info.getValue() === '-' ? '-' : <CopastorUpdateCard idRow={id} />;
    },
    header: () => {
      return (
        <Button
