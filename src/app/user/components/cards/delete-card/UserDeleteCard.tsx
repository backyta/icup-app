        ...
        <AlertDialogHeader className='h-auto'>
          ...
          <AlertDialogDescription>
            ...
            <span className='inline-block mb-2'>
              ❌ El registro de este Usuario se colocara en estado <span className='font-bold'>INACTIVO.</span>
            </span>
            <span className='inline-block mb-2'>
              ❌ El registro de este Usuario se eliminara de los lugares donde guardaba relación con Casa Familiar,
              Pastor, Co-Pastor, Predicador o Supervisor.
            </span>
            <span className='inline-block mb-2'>
              ℹ Para poder activarla nuevamente deberá hacerlo desde la pestaña de Actualizar Usuario.
            </span>
            <br />
          </AlertDialogDescription>
        </AlertDialogHeader>
