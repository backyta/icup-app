...
import { type DataUserKeys, type UserData } from '@/app/user/interfaces';
...
import { UserRoleNames, UserRoles } from '@/shared/enums';
...
export const UserFormUpdate = ({ onSubmit }: UserMemberProps): JSX.Element => {
  ...
  }, [watchFirstName, watchTyLastName, watchTypeEmail, watchTypePassword, watchTypeConfirmPassword, watchTypeRoles]);
                  ...
                  render={({ field }) => {
                    return (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input disabled={disableInput} placeholder='Nombres del usuario' type='text' {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    );
                  ...
                  render={({ field }) => {
                    return (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input disabled={disableInput} placeholder='Apellidos del usuario' type='text' {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    );
