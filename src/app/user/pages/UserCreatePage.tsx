...
export const UserCreatePage = (): JSX.Element => {
  ...
  return (
    <>
      <h1 className='text-center pb-4 pt-0 font-sans text-2xl sm:text-3xl font-bold text-user-color text-[2rem] sm:text-[2.5rem] md:text-[2.5rem] lg:text-[2.8rem] xl:text-5xl'>
        Modulo Usuario
      </h1>
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className='max-w-md w-full flex flex-col gap-4'>
            <FormField
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Nombres</FormLabel>
                    <FormControl>
                      <Input placeholder='Nombres del usuario' type='text' {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                );
            ...
            <FormField
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Apellidos</FormLabel>
                    <FormControl>
                      <Input placeholder='Apellidos del usuario' type='text' {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                );
            ...
            <FormField
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    <FormLabel className='text-[14px] sm:text-[15px] lg:text-base font-bold'>Contraseña</FormLabel>
                    <FormControl>
                      <Input placeholder='Contraseña' autoComplete='new-password' type='password' {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                );
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  <div className='mb-4'>
                    <FormLabel className='text-[14px] sm:text-[15px] lg:text-[17px] font-bold'>Roles</FormLabel>
                              ...
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                  ...
                                  checked
                                    ...
                                    : (updatedRoles = field.value?.filter((value) => value !== role) ?? []);

                                  field.onChange(updatedRoles);
                                }}
                              />
                            </FormControl>
                            <FormLabel className='text-sm lg:text-[15px] font-normal'>{UserRoleNames[role]}</FormLabel>
                          </FormItem>
                        );
                      }}
                    />
            ...
            />
            <Button type='submit' className='w-full text-sm md:text-base xl:text-lg mt-12'>
              Registrar Usuario
            </Button>
          </form>
        </Form>
