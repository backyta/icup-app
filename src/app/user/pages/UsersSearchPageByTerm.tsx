...
import { type UserResponse, type UserSearchFormByTerm } from '@/app/user/interfaces';
import { userInfoColumns as columns, SearchByTermUserDataTable } from '@/app/user/components';
