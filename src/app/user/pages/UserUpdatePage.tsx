...
import { userSearchByTermFormSchema } from '@/app/user/validations';
import { type UserSearchFormByTerm, type UserResponse } from '@/app/user/interfaces';
import { userUpdateColumns as columns, SearchByTermUserDataTable } from '@/app/user/components';
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <p className='dark:text-slate-300 text-left font-sans font-bold px-4 text-[12.5px] md:text-[15px] xl:text-base sm:px-[1.5rem] xl:px-[2rem]'>
        Elige tus opciones de búsqueda para actualizar registros de usuarios.
      </p>
