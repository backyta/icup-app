  ...
  return (
    <div className='animate-fadeIn'>
      ...
      <div className='w-full px-[2rem] py-6 sm:px-[7rem] md:px-[4rem] lg:px-[3rem] xl:px-[3rem] 2xl:px-16 grid gap-8 md:gap-6 xl:gap-5 2xl:gap-4 grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1 2xl:grid-cols-4 2xl:grid-rows-1 h-auto 2xl:h-[43rem]'>
        <NavLink
          key='/supervisors/create-supervisor'
          to='/supervisors/create-supervisor'
          end
        ...
        <NavLink
          key='/supervisors/search-supervisors'
          to='/supervisors/search-supervisors'
          end
        ...
        <NavLink
          key='/supervisors/search-by-term-supervisors'
          to='/supervisors/search-by-term-supervisors'
          end
        ...
        <NavLink
          key='/supervisors/update-supervisor'
          to='/supervisors/update-supervisor'
          end
        ...
        <NavLink
          key='/supervisors/delete-supervisor'
          to='/supervisors/delete-supervisor'
          end
