...
export const MemberAnalysisCardByZone = (): JSX.Element => {
  //* States
    ...
    <Card className='bg-slate-50/40 dark:bg-slate-900/40 flex flex-col col-start-1 col-end-2 h-[22rem] lg:h-[25rem] 2xl:h-[26rem] m-0 border-slate-200 dark:border-slate-800'>
                      ...
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button
                            ...
                            role='combobox'
                            className={cn(
                              'justify-between w-full text-center overflow-hidden px-2',
      ...
      >
        ...
        >
          ...
          <Area type='monotone' dataKey='Varones' stackId='1' stroke='#1acd71' fill='#1acd71' />
          <Area type='monotone' dataKey='Mujeres' stackId='1' stroke='#ced220' fill='#ced220' />
        </AreaChart>
      </ResponsiveContainer>
    </Card>
  );
