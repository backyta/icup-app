...
import { churchInfoColumns } from '@/app/church/components';

import { DataTableSearchByTerm } from '@/shared/components';

export const ChurchSearchPageByTerm = (): JSX.Element => {
  return (
    <div>
      ...
      <div className='px-4 md:-px-2 md:px-[2rem] xl:px-[3rem] py-4 w-full'>
        <DataTableSearchByTerm columns={churchInfoColumns} data={data} />
      </div>
    </div>
  );
};
