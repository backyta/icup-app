...
import { offeringsColumns } from '@/components/table-members/offerings-columns';
import { dataOfferings as data } from '@/data/data-offerings';

export const SearchOfferingsPage = (): JSX.Element => {
  return (
    <div>
      ...
      <div className='px-4 md:-px-2 lg:px-[2rem] xl:px-[3rem] 2xl:px-36 py-4 w-full'>
        <DataTable columns={offeringsColumns} data={data} />
      </div>
    </div>
  );
};
