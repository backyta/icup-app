...
export const SearchLeadersPage = (): JSX.Element => {
  return (
    <div>
      ...
      <p className='dark:text-slate-300 text-left font-sans font-bold px-4 sm:px-2 text-sm md:text-[15px] xl:text-base xl:px-[2rem] 2xl:px-24'>
        Busca, filtra u ordena los lideres que necesites.
      </p>
...
// NOTE: para ofrendas casas y usuarios crear una columnas diferentes en el mismo archivo y exportarlas
