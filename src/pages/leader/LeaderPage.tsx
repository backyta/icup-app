...
export const LeaderPage = (): JSX.Element => {
  ...
  return (
    <>
      <h1 className='text-center p-2 md:p-4 font-sans text-2xl sm:text-3xl font-bold text-leader-color text-[2rem] sm:text-[2.4rem] md:text-[2.6rem] lg:text-5xl xl:text-5xl'>
        Modulo Líder
      </h1>
      ...
      <div className='w-full grid gap-4 grid-cols-2 grid-rows-3 md:grid-cols-2 md:grid-rows-4 lg:grid-cols-2 lg:grid-rows-5 2xl:grid-cols-4 2xl:grid-rows-1 h-[50rem] sm:h-[67rem] md:h-[70rem] lg:h-[68rem] xl:h-[63rem] 2xl:h-[63rem] mt-[2rem]'>
        ...
        >
          ...
          >
            <FcManager className='text-[12rem]' />
