...
export const PastorOptionsPage = (): JSX.Element => {
  ...
  return (
    <>
      <h1 className='text-center pb-2 pt-1 md:pt-2 md:pb-2 font-sans text-2xl sm:text-3xl font-bold text-pastor-color text-[2rem] sm:text-[2.4rem] md:text-[2.6rem] lg:text-5xl xl:text-5xl'>
        Modulo Pastor
      </h1>
      ...
      <div className='w-full px-[2rem] py-[1.5rem] sm:px-[7rem] sm:py-[2rem] md:px-[4rem] lg:px-[3rem] lg:py-[2rem] xl:px-[3rem] xl:py-8 2xl:px-16 2xl:pt-12 grid gap-8 md:gap-6 xl:gap-5 2xl:gap-4 grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1 2xl:grid-cols-4 2xl:grid-rows-1 h-auto 2xl:h-[55rem]'>
        ...
        <NavLink
          key='/pastors/search-by-term-pastors'
          to='/pastors/search-by-term-pastors'
          end
