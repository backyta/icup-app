import { DataTableSearchGeneral, memberColumns } from '@/components/data-table';

import { dataMembers as data } from '../../data/data-members';

export const GeneralCopastorsSearchPage = (): JSX.Element => {
  return (
    <div>
      ...
      <p className='dark:text-slate-300 text-left font-sans font-bold px-4 sm:px-2 text-sm md:text-[15px] xl:text-base xl:px-[2rem] 2xl:px-24'>
        Busca, filtra u ordena los co-pastores que necesites.
      </p>
