...
import { zoneDeleteColumns as columns, SearchByTermZoneDataTable } from '@/modules/zone/components';
...
export const ZoneDeletePage = (): JSX.Element => {
  ...
  return (
    <div className='animate-fadeInPage'>
      ...
      <SearchTitle isDeleteSearch className='text-red-500' titleName={'zonas'} />
