...
export const ZoneInactivationReasonNames: Record<ZoneInactivationReason, string> = {
  ...
  [ZoneInactivationReason.SupervisorResignation]: 'Renuncia o inactividad prolongada del supervisor.',
  [ZoneInactivationReason.LeadershipConflicts]: 'Conflictos graves entre el supervisor y los discípulos o grupos familiares.',
  [ZoneInactivationReason.LeadershipIncapacity]: 'Incapacidad del liderazgo para cumplir con las responsabilidades.',
  ...
  [ZoneInactivationReason.AccessIssues]: 'Dificultades de acceso al área por problemas de infraestructura.',

  [ZoneInactivationReason.NaturalDisasters]: 'Desastres naturales que afectan la operatividad de la zona.',
  [ZoneInactivationReason.HealthCrisis]: 'Pandemias u otras crisis sanitarias que impiden el desarrollo de actividades.',
  [ZoneInactivationReason.ResourceShortage]: 'Falta de recursos básicos en la zona (agua, electricidad, etc.).',
};
...
export const LeadershipIssuesReasonsNames: Record<LeadershipIssuesReasons, string> = {
  [LeadershipIssuesReasons.SupervisorResignation]: 'Renuncia o inactividad prolongada del supervisor',
  [LeadershipIssuesReasons.LeadershipConflicts]: 'Conflictos graves entre el supervisor y los discípulos o grupos familiares',
  [LeadershipIssuesReasons.LeadershipIncapacity]: 'Incapacidad del liderazgo para cumplir con las responsabilidades',
...
export const LackOfActivityOrCommitmentReasonsNames: Record<LackOfActivityOrCommitmentReasons, string> = {
  [LackOfActivityOrCommitmentReasons.GeneralInactivity]: 'Inactividad general en los grupos familiares',
  [LackOfActivityOrCommitmentReasons.LackOfParticipation]: 'Falta de participación en actividades o eventos',
  [LackOfActivityOrCommitmentReasons.LowDiscipleCommitment]: 'Bajo compromiso de los discípulos asignados',
};
...
export const ExternalFactorsReasonsNames: Record<ExternalFactorsReasons, string> = {
  [ExternalFactorsReasons.DemographicChanges]: 'Cambios demográficos significativos en el área geográfica (migración, urbanización, etc.)',
  [ExternalFactorsReasons.LegalRestrictions]: 'Restricciones legales o gubernamentales',
  [ExternalFactorsReasons.AccessIssues]: 'Dificultades de acceso al área por problemas de infraestructura',
};
...
export const UnavoidableCircumstancesReasonsNames: Record<UnavoidableCircumstancesReasons, string> = {
  [UnavoidableCircumstancesReasons.NaturalDisasters]: 'Desastres naturales que afectan la operatividad de la zona',
  [UnavoidableCircumstancesReasons.HealthCrisis]: 'Pandemias u otras crisis sanitarias que impiden el desarrollo de actividades',
  [UnavoidableCircumstancesReasons.ResourceShortage]: 'Falta de recursos básicos en la zona (agua, electricidad, etc.)',
};
