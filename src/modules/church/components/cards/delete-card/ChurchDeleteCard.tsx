...
import { useChurchDeletionMutation } from '@/modules/church/hooks';
...
export const ChurchDeleteCard = ({ idRow }: ChurchDeleteCardProps): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (idRow && isCardOpen) {
      ...
      url.pathname = `/churches/delete/${idRow}/remove`;
  ...
  //* Custom hooks
  const churchDeletionMutation = useChurchDeletionMutation({
    setIsCardOpen,
    setIsButtonDisabled,
  });
        ...
        <div className='flex justify-center md:justify-end gap-x-4'>
          ...
          <Button
            ...
            onClick={() => {
              ...
              churchDeletionMutation.mutate(idRow);
            }}
