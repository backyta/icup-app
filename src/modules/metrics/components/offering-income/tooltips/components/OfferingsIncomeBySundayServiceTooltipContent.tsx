...
import { type OfferingsIncomePayloadBySundayService } from '@/modules/metrics/components/offering-income/tooltips/interfaces';

export const OfferingsIncomeBySundayServiceTooltipContent = (
  props: TooltipConfig<OfferingsIncomePayloadBySundayService>
): JSX.Element => {
