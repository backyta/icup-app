...
import { type OfferingsIncomePayloadByFamilyGroup } from '@/modules/metrics/components/offering-income/tooltips/interfaces';

export const OfferingsIncomeByFamilyGroupTooltipContent = (
  props: TooltipConfig<OfferingsIncomePayloadByFamilyGroup>
): JSX.Element => {
