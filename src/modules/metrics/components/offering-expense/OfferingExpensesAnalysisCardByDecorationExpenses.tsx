...
export const OfferingExpensesAnalysisCardByDecorationExpenses = (): JSX.Element => {
  //* States
    ...
    <Card className='bg-slate-50/40 dark:bg-slate-900/40 flex flex-col col-start-1 col-end-2 h-[22rem] lg:h-[25rem] 2xl:h-[26rem] m-0 border-slate-200 dark:border-slate-800'>
      ...
      >
        ...
        >
          ...
          <Area type='monotone' dataKey='Total' stroke='#c04dfe' fill='#c04dfe' />
        </AreaChart>
      </ResponsiveContainer>
    </Card>
  );
