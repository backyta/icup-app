...
const dataJanuary = [
  ...
  {
    SubTipo: 'Alq. equip. técnicos y logísticos',
    ExpenseOne: {
      date: '03/01/24',
      amount: 48.6,
    },
  ...
  {
    SubTipo: 'Trans. invit. especiales',
    ExpenseOne: {
      date: '06/01/24',
      amount: 57.3,
    },
...
export const OfferingExpensesAnalysisCardByActivitiesAndEventsExpenses = (): JSX.Element => {
  //* States
    ...
    <Card className='bg-slate-50/40 dark:bg-slate-900/40 flex flex-col col-start-2 col-end-3 h-[22rem] lg:h-[25rem] 2xl:h-[26rem] m-0 border-slate-200 dark:border-slate-800'>
      ...
      >
        ...
        >
          ...
          <Area type='monotone' dataKey='Total' stroke='#f8a408' fill='#f8a408' />
        </AreaChart>
      </ResponsiveContainer>
    </Card>
  );
