...
import { getOfferingExpenseMetricsReport } from '@/modules/metrics/services';
import { offeringExpenseReportFormSchema } from '@/modules/metrics/validations';
...
export const OfferingExpenseReportForm = ({ churchId, dialogClose }: Props): JSX.Element => {
  //* States
  ...
  const form = useForm<z.infer<typeof offeringExpenseReportFormSchema>>({
    ...
    defaultValues: {
      types: Object.values(MetricOfferingExpenseSearchType),
      church: churchId,
  ...
  //* Form handler
  const handleSubmit = (formData: z.infer<typeof offeringExpenseReportFormSchema>): void => {
              ...
              >
                ...
                <div className='flex gap-3 items-center'>
                  <FormField
                    ...
                    render={({ field }) => {
                      return (
                        <FormItem className='flex justify-start gap-3 items-center'>
                          <div className='w-auto'>
                            <FormLabel className='text-[14px] md:text-[14.5px] font-bold'>
