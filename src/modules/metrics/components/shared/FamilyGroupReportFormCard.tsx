...
import { FamilyGroupReportForm } from '@/modules/metrics/components/shared';
...
export const FamilyGroupReportFormCard = ({ churchId }: Props): JSX.Element => {
  //* State
  ...
  return (
    <>
      <Dialog open={setOpen} onOpenChange={setIsOpen}>
        ...
        >
          <FamilyGroupReportForm churchId={churchId} dialogClose={handleContainerClose} />
        </DialogContent>
      </Dialog>
    </>
  );
