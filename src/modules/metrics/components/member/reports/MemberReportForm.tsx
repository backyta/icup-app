...
import { memberReportFormSchema } from '@/modules/metrics/validations/report-form-schema';
...
export const MemberReportForm = ({ churchId, dialogClose }: Props): JSX.Element => {
  ...
  return (
    ...
    >
      <h2 className='text-center -mt-8 text-amber-500 leading-6 pb-1 font-bold text-[24px] sm:text-[26px] md:text-[28px]'>
        Generar Reporte
      </h2>
