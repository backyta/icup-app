...
import { type IncomeAndExpensesComparativePayload } from '@/modules/metrics/components/financial-balance-comparative/tooltips/interfaces';
  ...
  return (
    <div className='grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-border/50 bg-background px-2.5 py-1.5 text-xs shadow-xl'>
      ...
      <div className='flex items-center'>
        ...
        ></span>
        <p className='font-medium text-[11.5px] md:text-[13px] text-[#4ecb17]'>
          Ingresos Totales:
      ...
      <div className='flex items-center'>
        ...
        ></span>
        <p className='font-medium text-[11.5px] md:text-[13px] text-[#ec564b]'>
          Salidas Totales:
