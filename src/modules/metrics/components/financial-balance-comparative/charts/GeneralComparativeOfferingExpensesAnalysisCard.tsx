...
import { getGeneralComparativeOfferingExpenses } from '@/modules/metrics/services';
import { GeneralComparativeOfferingExpensesTooltipContent } from '@/modules/metrics/components/financial-balance-comparative/tooltips/components';
...
export const ComparativeOfferingExpensesAnalysisCard = ({ churchId }: Props): JSX.Element => {
  ...
  const generalComparativeOfferingExpenses = useQuery({
    queryKey: ['general-comparative-offering-expenses', { ...searchParams, church: churchId }],
    queryFn: async () => {
