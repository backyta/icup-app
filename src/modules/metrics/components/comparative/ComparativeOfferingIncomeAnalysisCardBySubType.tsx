...
export const ComparativeOfferingIncomeAnalysisCardBySubType = (): JSX.Element => {
  ...
  //* Effects
  useEffect(() => {
    if (year === '2025' && subType === OfferingIncomeCreationSubType.FamilyGroup) {
      setDataResult(data2025);
    }
    if (year === '2026' && subType === OfferingIncomeCreationSubType.FamilyGroup) {
      setDataResult(data2026);
    }
    if (year === '2024' && subType === OfferingIncomeCreationSubType.FamilyGroup) {
