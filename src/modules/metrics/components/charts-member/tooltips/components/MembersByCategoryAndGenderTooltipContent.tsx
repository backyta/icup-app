...
import { type MembersByCategoryAndGenderTooltipConfig } from '@/modules/metrics/components/charts-member/tooltips/interfaces';

export const MembersByCategoryAndGenderTooltipContent = (
  props: MembersByCategoryAndGenderTooltipConfig
): JSX.Element => {
