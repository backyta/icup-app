...
import { type MembersByDistrictAndGenderTooltipConfig } from '@/modules/metrics/components/charts-member/tooltips/interfaces';

export const MembersByDistrictAndGenderTooltipContent = (
  props: MembersByDistrictAndGenderTooltipConfig
): JSX.Element => {
