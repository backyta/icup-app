...
import { type MembersByRoleAndGenderTooltipConfig } from '@/modules/metrics/components/charts-member/tooltips/interfaces';

export const MembersByRoleAndGenderTooltipContent = (
  props: MembersByRoleAndGenderTooltipConfig
): JSX.Element => {
