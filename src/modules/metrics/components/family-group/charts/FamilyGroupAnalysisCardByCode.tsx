...
export const FamilyGroupAnalysisCardByCode = ({ churchId }: Props): JSX.Element => {
  //* States
          ...
          {!!mappedData?.length && searchParams && (
            ...
            >
              ...
              >
                ...
                <ChartTooltip cursor={false} content={FamilyGroupsByCodeTooltipContent as any} />
