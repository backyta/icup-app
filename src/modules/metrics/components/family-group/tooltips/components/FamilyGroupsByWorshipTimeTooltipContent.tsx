...
import { type FamilyGroupsByWorshipTimePayload } from '@/modules/metrics/components/family-group/tooltips/interfaces';

export const FamilyGroupsByWorshipTimeTooltipContent = (
  props: TooltipConfig<FamilyGroupsByWorshipTimePayload>
): JSX.Element => {
