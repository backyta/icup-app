...
import { getGeneralPreachersReport, getPreachers } from '@/modules/preacher/services';
import { type PreacherQueryParams } from '@/modules/preacher/interfaces';
    ...
    <div>
      ...
      {!isFiltersSearchGeneralDisabled && (
        <div>
          ...
          <span className='font-medium text-[13px] md:text-[15px]'>Predicadores (Todos)</span>
