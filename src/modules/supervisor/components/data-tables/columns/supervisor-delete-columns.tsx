...
import { SupervisorInfoCard, SupervisorDeleteCard } from '@/modules/supervisor/components';

import { Button } from '@/shared/components/ui/button';
import { type SupervisorColumns } from '@/modules/supervisor/interfaces';

export const supervisorDeleteColumns: Array<ColumnDef<SupervisorColumns, any>> = [
  {
    accessorKey: 'id',
    cell: (info) => {
...

  {
    ...
    cell: (info) => {
      const id = info.row.original.id;
      return info.getValue() === '-' ? '-' : <SupervisorDeleteCard idRow={id} />;
    },
    header: () => {
      return (
        <Button
