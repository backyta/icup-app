...
import { getGeneralSupervisorsReport, getSupervisors } from '@/modules/supervisor/services';
import { type SupervisorQueryParams } from '@/modules/supervisor/interfaces';
    ...
    <div>
      ...
      {!isFiltersSearchGeneralDisabled && (
        <div>
          ...
          <span className='font-medium text-[13px] md:text-[15px]'>Supervisores (Todos)</span>
