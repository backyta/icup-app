      ...
      <TabsContent value='general-info'>
        <Card className='w-full '>
          ...
          <CardContent className='grid grid-cols-3 gap-x-4 gap-y-2.5 px-4 md:gap-x-6 md:gap-y-5 md:pl-[4.3rem] md:pr-[2.5rem]'>
            ...
            <span className='pt-2 md:pt-0 col-start-1 col-end-4 row-start-5 row-end-6 md:row-start-auto md:row-end-auto text-[15px] md:text-[16px] font-bold text-yellow-500'>
