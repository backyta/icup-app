...
import { useCopastorDeletionMutation } from '@/modules/copastor/hooks';

import { Button } from '@/shared/components/ui/button';
import { Dialog, DialogContent, DialogTrigger } from '@/shared/components/ui/dialog';

interface CopastorDeleteCardProps {
  idRow: string;
}

export const CopastorDeleteCard = ({ idRow }: CopastorDeleteCardProps): JSX.Element => {
  //* States
  ...
  //* Custom hooks
  const copastorDeletionMutation = useCopastorDeletionMutation({
    setIsCardOpen,
    setIsButtonDisabled,
  });
        ...
        <div className='flex justify-center md:justify-end gap-x-4'>
          ...
          <Button
            ...
            onClick={() => {
              ...
              copastorDeletionMutation.mutate(idRow);
            }}
