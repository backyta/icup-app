export enum OfferingIncomeEliminationReasonType {
...
export const OfferingIncomeEliminationReasonTypeNames: Record<OfferingIncomeEliminationReasonType, string> = {
