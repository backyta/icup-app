import { dataOfferingsIncome as data } from '@/modules/offering/income/data';
import { offeringIncomeDeleteColumns } from '@/modules/offering/income/components';
  ...
  return (
    <div>
      ...
      <div className='px-4 md:-px-2 md:px-[2rem] xl:px-[3rem] py-4 w-full'>
        <DataTableSearchByTerm columns={offeringIncomeDeleteColumns} data={data} />
      </div>
    </div>
  );
};
