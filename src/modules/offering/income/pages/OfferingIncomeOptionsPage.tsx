  ...
  return (
    <div className='animate-fadeIn'>
      ...
      <div className='w-full px-[2rem] py-6 sm:px-[7rem] md:px-[4rem] lg:px-[3rem] xl:px-[3rem] 2xl:px-16 grid gap-8 md:gap-6 xl:gap-5 2xl:gap-4 grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1 2xl:grid-cols-4 2xl:grid-rows-1 h-auto 2xl:h-[43rem]'>
        <NavLink
          key='/offerings/incomes/create'
          to='/offerings/incomes/create'
          end
        ...
        <NavLink
          key='/offerings/incomes/general-search'
          to='/offerings/incomes/general-search'
          end
        ...
        <NavLink
          key='/offerings/incomes/search-by-term'
          to='/offerings/incomes/search-by-term'
          end
        ...
        <NavLink
          key='/offerings/incomes/update'
          to='/offerings/incomes/update'
          end
        ...
        <NavLink
          key='/offerings/incomes/delete'
          to='/offerings/incomes/delete'
          end
