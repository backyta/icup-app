  ...
  return (
    <div className='animate-fadeIn'>
      ...
      <div className='w-full px-[2rem] py-6 sm:px-[7rem] md:px-[4rem] lg:px-[3rem] xl:px-[3rem] 2xl:px-16 grid gap-8 md:gap-6 xl:gap-5 2xl:gap-4 grid-cols-1 grid-rows-1 lg:grid-cols-2 lg:grid-rows-1 2xl:grid-cols-4 2xl:grid-rows-1 h-auto 2xl:h-[43rem]'>
        <NavLink
          key='/offerings/income/create-offering-income'
          to='/offerings/income/create-offering-income'
          end
        ...
        <NavLink
          key='/offerings/income/search-offerings-income'
          to='/offerings/income/search-offerings-income'
          end
        ...
        <NavLink
          key='/offerings/income/search-by-term-offerings-income'
          to='/offerings/income/search-by-term-offerings-income'
          end
        ...
        >
          <WhiteCard centered>
            ...
            <p className='font-bold text-xs sm:text-sm lg:text-[15px] xl:text-[16px]'>
              Consultar registros de ingreso de ofrendas por tipo.
            </p>
          </WhiteCard>
        </NavLink>

        <NavLink
          key='/offerings/income/update-offering-income'
          to='/offerings/income/update-offering-income'
          end
        ...
        <NavLink
          key='/offerings/income/delete-offering-income'
          to='/offerings/income/delete-offering-income'
          end
