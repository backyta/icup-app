import { offeringExpensesInfoColumns } from '@/modules/offering/expenses/components';
...
export const OfferingsExpensesGeneralSearchPage = (): JSX.Element => {
  return (
    <div>
      ...
      <div className='px-4 md:-px-2 md:px-[2rem] xl:px-[3rem] py-4 w-full'>
        <DataTableSearchGeneral columns={offeringExpensesInfoColumns} data={data} />
      </div>
    </div>
  );
};
