...
import {
  ...
  OfferingExpensesUpdateCard,
} from '@/modules/offering/expenses/components';

import { Button } from '@/shared/components/ui/button';

import { type OfferingColumns } from '@/modules/offering/shared/interfaces';

export const offeringExpensesUpdateColumns: Array<ColumnDef<OfferingColumns, any>> = [
  {
    accessorKey: 'id',
    header: ({ column }) => {
      return (
  ...
  },
  {
    id: 'updateInfo',
    cell: () => {
      return <OfferingExpensesUpdateCard />;
    },
  },
];
