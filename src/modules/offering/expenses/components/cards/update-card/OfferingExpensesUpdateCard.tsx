...
import { OfferingExpensesFormUpdate } from '@/modules/offering/expenses/components';

import { Button } from '@/shared/components/ui/button';
import { Dialog, DialogContent, DialogTrigger } from '@/shared/components/ui/dialog';

export const OfferingExpensesUpdateCard = (): JSX.Element => {
  //* States
