...
export const OfferingExpenseSearchSubTypeNames: Record<OfferingExpenseSearchSubType, string> = {
  ...
  [OfferingExpenseSearchSubType.ComputerEquipmentRepairAndMaintenance]: 'Mant. Equipos informáticos',
...
export const SubTypeNamesOfferingExpenseSearchByOperativeExpenses: Record<SubTypeOfferingExpenseSearchByOperativeExpenses, string> =  {
  ...
  [SubTypeOfferingExpenseSearchByOperativeExpenses.TransportationAndTravelAllowance]: 'Transporte y/o viáticos',
...
export const SubTypeNamesOfferingExpenseSearchByMaintenanceAndRepairExpenses: Record<SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses, string> =  {
  ...
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.CleaningServices]: 'Servicios de limpieza',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.HeatingAndACSystemMaintenance]: 'Mantenimiento de SC y AC',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.SoundEquipmentMaintenance]: 'Mant. Equipos de sonido',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.LightingEquipmentMaintenance]: 'Mant. Equipos de iluminación',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.GardenAndExteriorMaintenance]: 'Mant. Jardines y exteriores',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.FurnitureRepairAndMaintenance]: 'Mant. Muebles',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.ComputerEquipmentRepairAndMaintenance]: 'Mant. Equipos informáticos',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.GeneralEquipmentMaintenance]: 'Mant. Equipos en general',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.GeneralEquipmentRepairs]: 'Rep. Equipos en general',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.RoofAndStructuralRepairs]: 'Rep. Techo y estructuras',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.DoorAndWindowRepairs]: 'Rep. Puertas y ventanas',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.SoundEquipmentRepairs]: 'Rep. Equipos de sonido',
  [SubTypeOfferingExpenseSearchByMaintenanceAndRepairExpenses.LightingEquipmentRepairs]: 'Rep. Equipos de iluminación',
}
...
export const SubTypeNamesOfferingExpenseSearchByDecorationExpenses: Record<SubTypeOfferingExpenseSearchByDecorationExpenses, string> =  {
  [SubTypeOfferingExpenseSearchByDecorationExpenses.PurchaseFlowersAndPlants]: 'Compra de flores y plantas',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.PurchaseDecorativeFurniture]: 'Compra de muebles decorativos',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.PurchaseDecorativeItems]: 'Compra de artículos decorativos',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.DecorationServices]: 'Servicios de decoración general',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.LightingAndIlluminationServices]: 'Servicios de iluminación y efectos',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.StageSetupServices]: 'Servicios de montaje de escenario',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.EventDecorationRentals]: 'Alquiler de decoraciones especiales',
  [SubTypeOfferingExpenseSearchByDecorationExpenses.CleaningPostEventServices]: 'Servicios de limpieza post-evento',
}
...
export const SubTypeNamesOfferingExpenseSearchByEquipmentAndTechnologyExpenses: Record<SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses, string> =  {
  ...
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.HvacEquipment]: 'Equipos de ventilación, SC y AC',
  ...
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.ConstructionEquipment]: 'Equipos de construcción',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.KitchenEquipment]: 'Equipos de cocina',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.CleaningEquipment]: 'Equipos de limpieza',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.AudioVideoRecordingEquipment]: 'Equipos de grabación (a/v)',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.OfficeFurniture]: 'Mobiliarios informáticos',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.KitchenFurniture]: 'Mobiliarios de cocina',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.GeneralFurniture]: 'Mobiliarios en general',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.MusicalInstruments]: 'Instrumentos musicales',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.InternetTelephoneServices]: 'Serv. Internet y telefonía',
  [SubTypeOfferingExpenseSearchByEquipmentAndTechnologyExpenses.HostingSoftwareServices]: 'Serv. Hosting y software',
...
export const SubTypeNamesOfferingExpenseSearchBySuppliesExpenses: Record<SubTypeOfferingExpenseSearchBySuppliesExpenses, string> =  {
  ...
  [SubTypeOfferingExpenseSearchBySuppliesExpenses.PaintingSupplies]: 'Utensilios y materiales de pintura',
  [SubTypeOfferingExpenseSearchBySuppliesExpenses.ElectricalSupplies]: 'Materiales de electricidad',
  [SubTypeOfferingExpenseSearchBySuppliesExpenses.ConstructionTools]: 'Herramientas de construcción',
  [SubTypeOfferingExpenseSearchBySuppliesExpenses.AudioVisualSupplies]: 'Utensilios de audio y video ',
  [SubTypeOfferingExpenseSearchBySuppliesExpenses.SafetyEquipment]: 'Utensilios de seguridad.',
  [SubTypeOfferingExpenseSearchBySuppliesExpenses.FirstAidSupplies]: 'Insumos y utensilios de primeros auxilios',
}
...
export const SubTypeNamesOfferingExpenseSearchByPlaningEventsExpenses: Record<SubTypeOfferingExpenseSearchByPlaningEventsExpenses, string> =  {
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.AdvertisingAndEventPromotion]: 'Publicidad y promoción de eventos',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.SpecialGuestsFees]: 'Honorarios de invitados especiales',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.SecurityPersonnelFees]: 'Honorarios de personal de seguridad',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.SupportStaffFees]: 'Honorarios de personal de apoyo',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.ExternalVenueRental]: 'Alquiler de local externo',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.RentalTechnicalEquipment]: 'Alquiler de equipos técnicos',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.TransportationSpecialGuests]: 'Transporte de invitados especiales',
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.EquipmentTransportation]: 'Transporte de equipos',
  ...
  [SubTypeOfferingExpenseSearchByPlaningEventsExpenses.PrivateMobilityRental]: 'Alquiler de movilidad particular',
...
export const SubTypeNamesOfferingExpenseSearchByOtherExpenses: Record<SubTypeOfferingExpenseSearchByOtherExpenses, string> =  {
  [SubTypeOfferingExpenseSearchByOtherExpenses.FraternalSupport]: 'Apoyo a hermanos de la iglesia',
  [SubTypeOfferingExpenseSearchByOtherExpenses.MissionDonations]: 'Apoyo económico a misiones y misioneros',
  [SubTypeOfferingExpenseSearchByOtherExpenses.HospitalityExpenses]: 'Alojamiento y alimentación de invitados',
  [SubTypeOfferingExpenseSearchByOtherExpenses.TrainingAndEducation]: 'Capacitación para líderes y pastores',
  [SubTypeOfferingExpenseSearchByOtherExpenses.LegalAndAdministrative]: 'Gastos legales o administrativos',
  [SubTypeOfferingExpenseSearchByOtherExpenses.EmergencyRepairs]: 'Rep. urgentes de instalaciones y equipos',
